...
public class EnderecoDAOTest {
	...
	public void salvar() {
		...
		endereco.setNome("pega");
		endereco.setBairro("droga");
	...
	public void listar() {
		...
		for (Endereco endereco : resultado) {
			...
			System.out.println("Codigo do estado: " + endereco.getEstado().getCodigo());
			System.out.println("Estado: " + endereco.getEstado().getNome());
			System.out.println("Sigla do Estado: " + endereco.getEstado().getSigla());
			System.out.println();
		}
	}
	...
	public void editar(){
		...
		System.out.println("Código do Estado: " + endereco.getEstado().getCodigo());
		System.out.println("Nome do Estado: " + endereco.getEstado().getNome());
		System.out.println("Sigla do Estado: " + endereco.getEstado().getSigla());
		System.out.println();
